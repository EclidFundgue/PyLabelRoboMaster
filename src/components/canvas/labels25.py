...
class Labels25(CanvasComponent):
    '''Methods:
    1. ---------- add & delete & change ----------
    * startAdd() -> None
    * cancelAdd() -> None
    ...
    * saveToPath(path) -> None
    ...
    def __init__(self,
        ...
        num_keypoints: int,
        on_select: Callable[[Label25], None] = None
    ):
        ...
        self.adding_label: Label25 = None
        self.adding_point: Keypoint = None
        self.labels: List[Label25] = []
        self.selected_labels: List[Label25] = []
    ...
    def _loadSnapshot(self, snapshot: dict) -> None:
        ...
        for label_dict in snapshot['labels']:
            ...
            label_obj = Label25(points, label_dict['cls_id'])
            label_obj.icon = icon
    ...
    def _addLabelsIO(self,
        ...
        for label_io in labels_io:
            ...
            label = Label25(kpts, label_io.id)
    ...
    def startAdd(self) -> None:
        ...
        self.adding_point = _createKeypoint(*self.curr_mouse_pos, self._onAddPoint)
        self.adding_label = Label25([self.adding_point])
        self.addChild(self.adding_point)
    ...
    def relabel(self, img: pygame.Surface) -> None:
        ...
        for label_io in labels:
            ...
            label_obj = Label25(points, label_io.id)
            label_obj.icon = icon
            self.labels.append(label_obj)
    ...
    def _oneLabelSelection(self, clicked_labels: List[Label25]) -> None:
        for label in self.selected_labels:
            label.setSelected(False)
    ...
    def _multipleLabelSelection(self, clicked_labels: List[Label25]) -> None:
        for label in clicked_labels:
    ...
    def _handleLabelSelection(self, clicked_labels: List[Label25]) -> None:
